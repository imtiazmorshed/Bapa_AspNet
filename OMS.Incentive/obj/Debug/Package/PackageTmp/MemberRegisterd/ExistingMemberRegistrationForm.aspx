<%@ Page Title="" Language="C#" MasterPageFile="~/IncentiveWeb.Master" AutoEventWireup="true" CodeBehind="ExistingMemberRegistrationForm.aspx.cs" Inherits="OMS.Incentive.MemberRegisterd.ExistingMemberRegistrationForm" %>
...
<div class="form-group" style="margin-top: 40px">
    ...
    <div class="CompanyInformation displayNone">
        ...
        <div class="form-group ">
            <label for="inputPassword3" class="col-sm-3 control-label">Company Establishment Date</label>
            <div class="col-sm-6">
                <asp:TextBox ID="txtCompanyEstablishmentDate" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
        </div>
        <div class="form-group">
            <label for="inputPassword3" class="col-sm-3 control-label">Industry Foundation Date</label>
            <div class="col-sm-6">
