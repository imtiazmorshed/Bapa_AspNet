<%@ Page Title="" Language="C#" MasterPageFile="~/AdminIncentive.Master" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="OMS.Incentive.Admin.Invoice" %>
  ...
  <div class="panel-footer">
    ...
    <div runat="server" id="div1">
        ...
        <div class="form-group" style="margin-top: 30px">
            ...
            <div class="col-sm-6">
                <asp:TextBox CssClass="form-control" ID="txtNetWeight" runat="server"></asp:TextBox>
            </div>
        </div>
        <div class="form-group" style="margin-top: 30px">
            <label class="col-sm-3 control-label">
            ...
            <div class="col-sm-6">
                <asp:TextBox CssClass="form-control" ID="txtGrossWeight" runat="server"></asp:TextBox>
            </div>
        </div>
    </div>
