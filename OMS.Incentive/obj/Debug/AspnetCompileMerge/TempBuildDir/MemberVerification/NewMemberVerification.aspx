<%@ Page Title="" Language="C#" MasterPageFile="~/AdminIncentive.master" AutoEventWireup="true" CodeBehind="NewMemberVerification.aspx.cs" Inherits="OMS.Incentive.MemberVerification.NewMemberVerification" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>New Member Verification List
    </h1>
    <div runat="server">
