...
{
    public partial class MemberInvoiceList : System.Web.UI.Page
    {
        ...
        private void LoadPageData()
        {
            ...
            {
                List<Inv_Master> invoiceList = facade.MemberFacade.GetInvoiceByMemberID(MemberID);
                lvInvoiceList.DataSource = invoiceList;
