<%@ Page Language="C#" MasterPageFile="~/OMS.Master" AutoEventWireup="true" CodeBehind="ProfitAndLossView.aspx.cs"
    Inherits="OMS.WebClient.UIAccount.ProfitAndLossView" Title="" %>
            ...
            <td>
                <asp:Panel ID="pnlPrint" runat="server" valign="top">
                    <table width="100%">
                        ...
                        <tr>
                            <td colspan="2" align="right" bgcolor="#666666">
                                <asp:Label ID="lblBalanceTotal" runat="server" ForeColor="#F2F2F2" Font-Size="12"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
