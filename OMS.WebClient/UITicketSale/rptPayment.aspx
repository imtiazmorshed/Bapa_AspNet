<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptPayment.aspx.cs" Inherits="OMS.WebClient.UITicketSale.rptPayment" %>
                                ...
                                <td colspan="2">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label ID="Label11" runat="server" Text="Payable Amount:"></asp:Label>
                                            </td>
                                            <td align="left">
